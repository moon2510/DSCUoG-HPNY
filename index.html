...
<body>
   <header>
      ...
      <div id="new-year"><svg id="new-year-svg" version="1.1" xmlns="http://www.w3.org/2000/svg"
            ...
            <polyline id="happy-stroke" class="stroke-fill" clip-path="url(#happy-clip)" fill="none" stroke="#4F2525"
            ...
            <path id="underline-stroke" class="stroke-fill" clip-path="url(#underline-clip)" fill-rule="evenodd"
               clip-rule="evenodd" fill="none" stroke="#601B1B" stroke-width="12" stroke-linecap="round"
               stroke-linejoin="round" stroke-miterlimit="10" d="M494,191.5c0,0-134.006-0.858-164-1s-327.5,0-327.5,0" />
            <path id="n-stroke" class="stroke-fill" clip-path="url(#new-clip)" fill="none" stroke="#4F2525" stroke-width="10"
            ...
            <path id="ew-stroke" class="stroke-fill" clip-path="url(#new-clip)" fill="none" stroke="#4F2525" stroke-width="9"
               stroke-linejoin="round" stroke-miterlimit="10"
            ...
            <path id="y-stroke" class="stroke-fill" clip-path="url(#y-clip)" fill="none" stroke="#4F2525" stroke-width="10"
               stroke-linejoin="round" stroke-miterlimit="10"
            ...
            <path id="ye-stroke" class="stroke-fill" clip-path="url(#ye-clip)" fill="none" stroke="#4F2525" stroke-width="9"
               stroke-linejoin="round" stroke-miterlimit="10"
            ...
            <path id="ear-stroke" class="stroke-fill" clip-path="url(#ear-clip)" fill="none" stroke="#4F2525" stroke-width="9"
               stroke-linejoin="round" stroke-miterlimit="10"
            ...
            <script type="text/javascript">
               ...
               function displayContents() {
                  if (reader.readyState == 4) {
                     ...
                     var rd = Math.floor(Math.random() * 60)
         ...
         <script>
            (function () {
               var animation = {
                  ...
                  get period() {
                     var dateFuture = new Date(new Date().getFullYear(), 1, 12);
   ...
   <div class="buffalo">
      <img src="/Image/bf1.png" />
   </div>
   <div class="buffalo" id="bfright">
      <img src="/Image/bf2.png" />
   </div>
   </section>
